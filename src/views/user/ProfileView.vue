<template>
  <div class="container mx-auto p-4">
    ...
    <ProfilePictureUploadModal 
      :visible="showProfilePictureUploadModal" 
      @close="closeProfilePictureUploadModal()"
...
const showProfilePictureUploadModal = ref(false);

const onUploadSuccess = (newImageUrl: string) => {
  showProfilePictureUploadModal.value = false;
};
...
const openProfilePictureUploadModal = () => {
  showProfilePictureUploadModal.value = true;
};

const closeProfilePictureUploadModal = () => {
  showProfilePictureUploadModal.value = false;
};
</script>