...
import { PATH_ROOT, NAME_REGISTER, NAME_HOME } from '@/constants/routes';
...
function onUserLoggedIn(): void {
  const redirectPath = (route.query.redirect as string) || { name: NAME_HOME };
...
<template>
  ...
  <Teleport to="body">
    ...
    <LoadingOverlay v-if="auth.isLoading" />
  </Teleport>
</template>