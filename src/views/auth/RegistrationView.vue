...
import { useAuthStore } from '@/store/auth.store' // Aunque RegistrationForm ya no usa authStore, se mantiene si es necesario para LoadingOverlay
import LoadingOverlay from '@/components/ui/LoadingOverlay.vue'
import { NAME_LOGIN } from '@/constants/routes';

// --- SECCIÓN DE CONSTANTES ---
const router = useRouter()
const authStore = useAuthStore() // Se mantiene si `LoadingOverlay` se basa en `authStore.isLoading` global
