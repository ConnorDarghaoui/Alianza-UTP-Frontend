...
import { useUserStore } from '@/store/user.store'; // Para mostrar toasts
...
// Estado local con shallowRef para mejor rendimiento
const fileInput = ref<HTMLInputElement | null>(null);
const isDragging = ref(false);
const selectedFile = shallowRef<File | null>(null);
const localPreviewUrl = shallowRef<string | null>(null); // Para la vista previa del archivo seleccionado localmente
